...
class _$ReceiptDtoImpl implements _ReceiptDto {
  ...
  @override
  String toString() {
    return 'ReceiptDto(title: $title, photo: $photo, description: $description, created_at: $created_at, id: $id)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, title, photo, description, created_at, id);
